          ...
          <div className="services_wrapper">
              ...
              <div className="service">
                  ...
                  <div className="container">
                      <div className="img_container">
                          <img
                              src={images.sweetiesRestaurant}
                              alt="Sweetie's Restaurant"
                          />
                      </div>

                      <div className="service_info">
                          <p>
                              Nestled in the heart of the manor lies a unique
                              dining experience – an outdoor restaurant that
                              offers delicious buffet breakfast and dinner
                              amidst the stunning natural surroundings.{" "}
                          </p>
                          <p>
                              This restaurant provides a one-of-a-kind culinary
                              adventure that combines the pleasure of enjoying a
                              meal with the thrill of being immersed in nature.
                              Imagine waking up to the sounds of chirping birds
                              and the cool breeze of the bush while indulging in
                              a sumptuous buffet breakfast.
                          </p>
                          <p>
                              Later in the day, you can enjoy a delectable
                              dinner while gazing at the starlit sky and
                              listening to the sounds of the wild. This bush
                              restaurant promises an unforgettable dining
                              experience that will leave you with lasting
                              memories.
                          </p>
                      </div>
                  </div>
              ...
              <div className="service">
                  ...
                  <div className="container">
                      ...
                      <div className="service_info">
                          <p>
                              Welcome to a serene and enchanting small garden, a
                              hidden oasis of tranquility that offers respite
                              from the hustle and bustle of everyday life. As
                              you step inside, you are greeted by the lush
                              greenery of the carpet grass, soft and inviting
                              under your feet.
                          </p>
                          <p>
                              The garden is enclosed by a stunning fence of
                              vibrant hibiscus flowers, adding a touch of color
                              and beauty to the peaceful surroundings. Here, you
                              can escape with your loved one and enjoy a moment
                              of peace and solitude, or come alone to read a
                              book, meditate, or simply soak up the serene
                              atmosphere.
                          </p>
                          <p>
                              This garden is a true haven, a place where you can
              ...
              <div className="service">
                  ...
                  <div className="container">
                      <div className="img_container">
                          <img
                              src={images.coupleHorseride}
                              alt="Couple Horse riding"
                          />
                      </div>

                      <div className="service_info">
                          <p>
                              Imagine having the wedding of your dreams in a
                              stunning location that's straight out of a fairy
                              tale, with two grand mansions, a sparkling pool,
                              and breathtaking grounds overlooking the lake. Our
                              luxurious rooms ensure that your guests will have
                              a comfortable stay, and the stunning scenery is an
                              ideal backdrop for your ceremony and photographs.
                          </p>

                          <p>
                              We understand the importance of your wedding day
                              and are committed to making it unforgettable. Our
                              experienced staff will take care of every detail,
                              from catering and decor to entertainment and
                              photography, ensuring that your day runs smoothly
                              and flawlessly. So, you can focus on enjoying the
                              moment with your loved ones.
                          </p>

                          <p>
                              So if you're looking for a truly magical
                              destination for your wedding day, look no further
